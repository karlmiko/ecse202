...
public class bTree {
	...
	// Traverse Left-Root-Right and start balls.
	public void startBalls(bNode root) {
		if (root.left != null) startBalls(root.left);
		root.randomBall.start();
		if (root.right != null) startBalls(root.right);
	}
